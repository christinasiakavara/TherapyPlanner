package DETsCode.ExtraFeatures.Message;
...
public boolean deleteMessage(int messageId) {
    try {
        ...
        PreparedStatement stmt = conn.getConnection().prepareStatement(query);
        stmt.setInt(1, messageId.getMessageid());
        stmt.setInt(2, messageId.getChatid());
        stmt.setInt(3, messageId.getSenderid());
        stmt.setInt(4, messageId.getReceiverid());
        stmt.setString(5,messageId.getContent());
        stmt.setTimestamp(6, java.sql.Timestamp.valueOf(messageId.getTimestamp()));
