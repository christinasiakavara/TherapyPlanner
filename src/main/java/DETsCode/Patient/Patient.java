...
import java.util.List;
    public class Patient extends User {
        ...
        public Patient(String firstname, String lastname, String email, String username, String password, String number,String address, String birthdate,int userid, int roleID, String medicalHistory, int patiendid, List <TherapySession> currentSessions) {
