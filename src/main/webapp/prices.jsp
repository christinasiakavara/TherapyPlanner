      ...
      <div class="col-md-4">
        <div class="price-card">
          ...
          <div class="price-body">
            ...
            <a href="signup.jsp?plan=basic" class="btn btn-success">Choose Plan</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="price-card">
          ...
          <div class="price-body">
            ...
            <a href="signup.jsp?plan=standard" class="btn btn-success">Choose Plan</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="price-card">
          ...
          <div class="price-body">
            ...
            <a href="signup.jsp?plan=premium" class="btn btn-success">Choose Plan</a>
          </div>
        </div>
      </div>
    </div>
